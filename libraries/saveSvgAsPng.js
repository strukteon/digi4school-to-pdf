(function() {
  ...
  const inlineImages = (el, options) => Promise.all(
    ...
    const convertToPng = ({src, width, height}) => {
      ...
      try {
        ...
        if ((typeof SecurityError !== 'undefined' && e instanceof SecurityError) || e.name === 'SecurityError') {
          console.error('Rendered SVG images cannot be downloaded in this browser.', e);
          alert("Ein Fehler ist aufgetreten: 'Rendered SVG images cannot be downloaded in this browser.'.\n\nBitte starte den Browser neu und versuche es erneut.")
          return;
        } else throw e;
      }
